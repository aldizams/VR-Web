				...
				<Stack gap={3} direction="horizontal">
					...
					<div>
						<div>
							...
							<p>Klik panah dibawah untuk berpindah lompat ke tempat lain</p>
						</div>
						<div>
							<svg
								xmlns="http://www.w3.org/2000/svg"
							...
							<p>Klik pada lingkaran untuk pindah ke tempat tertuju</p>
						</div>
					</div>
					<div>
						<div>
							...
							<p>Klik dan geser untuk melihat sekitar</p>
						</div>
						<div>
							<svg
								xmlns="http://www.w3.org/2000/svg"
							...
							<p>Scroll keatas dan kebawah untuk melakukan zoom</p>
						</div>
					</div>
				</Stack>
			</Card.Body>
